...
from mvht.model.lbs import lbs, vertices2landmarks, blend_shapes, vertices2joints
...
class FlameHead(nn.Module):
    ...
    def __init__(
        ...
        self.has_neck_base_joint=False
        ...
        laplacian_matrix = self.construct_laplacian(self.v_template.shape[0]) # num_vertices even with teeth added
    ...
    def construct_laplacian(self, num_vertices):
        """
        Constructs a Laplacian matrix for a fully connected graph.
        
        Args:
            num_vertices: Number of vertices in the graph.
        
        Returns:
            The Laplacian matrix as a PyTorch tensor.
        """
        adjacency_matrix = torch.ones(num_vertices, num_vertices)
        degree_matrix = torch.eye(num_vertices) * (num_vertices - 1)
