"""
Filename: TalkingHeadWrapper.py
...
def instantiate_fixed_view_renderer(apply_mask):
    renderer_cfg_str = f"""
            ...
            face_mask_path: /mnt/HDD3/nguyen/03_GS_based/StoplaPop_GA/inferno/assets/FLAME/mask/uv_face_mask.png
            face_eye_mask_path: /mnt/HDD3/nguyen/03_GS_based/StoplaPop_GA/inferno/assets/FLAME/mask/uv_face_eye_mask.png
            uv_size: 256
            image_size: 224
            topology_path: inferno/assets/FLAME/geometry/head_template.obj
            n_light: 27
...
class TalkingHeadWrapper(torch.nn.Module):
    ...
    def __init__(self, path_to_model, ckpt_mode='latest', render_results=True, use_preprocessor=True, apply_mask=True) -> None:
        super().__init__()
        self.talking_head_model, self.cfg = load_model(path_to_model.parent, path_to_model.name, mode=ckpt_mode, with_losses=False)
