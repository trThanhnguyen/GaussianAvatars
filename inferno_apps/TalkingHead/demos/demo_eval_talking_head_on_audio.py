# Filename: demo_eval_talking_head_on_audio.py
...
def main(): 
    ...
    parser.add_argument('--path_to_audio', type=str, default= str(get_path_to_assets() / "data/audios/obama_cropped.wav"))
    ...
    parser.add_argument('--save_video', action='store_true', help="If set, output images will be saved")
    parser.add_argument('--save_flame', action='store_true', help= "if set, output FLAME values for shape, expression, jaw pose will be saved")
    parser.add_argument('--save_mesh', action='store_true', help="If set, output meshes will be saved.")
    ...
    parser.add_argument('--subject_style', type=str, default='M022', help=f"Which subject style to use. Styles available: \n{training_ids}")
    ...
    parser.add_argument('--emotion', type=str, default='neutral', help="The emotion to generate. One of: neutral, Happy, Sad, Surprise, Fear, Disgust, Anger, Contempt. If 'all', all emotions will be generated.")
    parser.add_argument('--intensity', type=str, default='0', help="The emotion intentsity. One of: 0, 1, 2. If 'all', all emotions will be generated.")
    ...
    if args.emotion == 'all':
        ...
        for e in emotions:
            ...
            emotion_index_list += [AffectNetExpressions.from_str(emotion_name).value]
